...
public class AnalyticsUtils {
     ...
     */
    private static final String UACODE = "UA-3577058-7xfe";  // change to your own analytic id
    ...
    public static AnalyticsUtils getInstance(Context context) {
        ...
        if (sInstance == null) {
            sInstance = new AnalyticsUtils(context);  // get the single global app context.
        }
    ...
    private AnalyticsUtils(Context context) {
        ...
        mApplicationContext = context.getApplicationContext();  // single global app context
